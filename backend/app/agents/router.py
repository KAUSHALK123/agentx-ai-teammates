...
class AgentRouter:
    ...
    def _heuristic_route(self, request: str) -> RouteResult:
        ...
        ops_keywords = ["inventory", "stock", "warehouse", "logistics", "supply", "shipping", "operations", "operational", "report", "data", "audit", "exception", "exceptions", "business check", "record", "records", "analyze", "analysis", "attention"]
