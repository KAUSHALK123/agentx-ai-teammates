        ...
        if agent_id == "support":
            return StructuredTaskPlan(
                ...
                steps=[
                    PlanStep(
                        step_id=1,
                        action="Lookup customer profile and verify account status",
                        type="tool_action",
                    ...
                    PlanStep(
                        step_id=4,
                        action="Verify payment and delivery records against business criteria",
                        type="verification",
                        tool_id=None,
                        status="PENDING",
                    ),
            ...
            return StructuredTaskPlan(
                ...
                steps=[
                    PlanStep(
                        step_id=1,
                        action="Extract prospect details and lookup lead profile",
                        type="tool_action",
                        tool_id="lookup_lead",
                        status="PENDING",
                    ),
                    PlanStep(
                        step_id=2,
                        action="Evaluate lead qualification and determine status",
                        type="investigation",
                        tool_id=None,
                        status="PENDING",
                    ),
                    PlanStep(
                        step_id=3,
                        action="Update CRM lead qualification status and notes",
                        type="tool_action",
                        tool_id="update_lead",
                        status="PENDING",
                    ),
                    PlanStep(
                        step_id=4,
                        action="Log sales activity and follow-up record",
                        type="synthesis",
                        tool_id="create_activity",
                        status="PENDING",
                    ),
            ...
            return StructuredTaskPlan(
                ...
                steps=[
                    PlanStep(
                        step_id=1,
                        action="Retrieve business metrics and operational data",
                        type="tool_action",
                    ...
                    PlanStep(
                        step_id=2,
                        action="Analyze inventory status and operational exceptions",
                        type="investigation",
                        tool_id=None,
                        status="PENDING",
                    ),
                    PlanStep(
                        step_id=3,
                        action="Cross-verify operational records against reconciliation ledger",
                        type="verification",
                    ...
                    PlanStep(
                        step_id=4,
                        action="Log operational inspection activity record",
                        type="synthesis",
                        tool_id="create_activity",
                        status="PENDING",
                    ),
